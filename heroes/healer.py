class healer:
    ...
    def move(self, world, hero):
        ...
        if world.move_phase_num == 1 :
            ...
            # elif world.current_turn < 15:
                ...
                if hero.current_cell.is_in_objective_zone is False:
                    self.fixed.goal_cell["healer"] = self.fixed.zone_cell[0] if (world.get_hero_by_cell(allegiance=world.my_heroes,cell=self.fixed.zone_cell[0]) is None) else self.fixed.zone_cell[10]
        ...
        self.fixed.move_my_hero(world, hero, self.fixed.goal_cell["healer"])
    ...
    def action(self,  world, hero):
        for other_hero in world.my_heroes:
            ...
            if other_hero.current_hp <= (other_hero.max_hp - 30):
                ...
                self.fixed.attak_to_fucking_enemy(world, hero, self.Model.AbilityName.HEALER_ATTACK)
